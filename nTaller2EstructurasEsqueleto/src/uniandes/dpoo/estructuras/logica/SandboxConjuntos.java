...
public class SandboxConjuntos
{
    ...
    { 
    	...
    	listaReturn = new ArrayList<>(arbolCadenas);
    	return listaReturn;
    ...
    {
    	List<String> listaReturn;
    	listaReturn = new ArrayList<>(arbolCadenas.reversed());
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        while (iterator.hasNext()) {
            ...
            if (elemento.equalsIgnoreCase(cadenaMinuscula)) {
                iterator.remove();
            }
        }
    }
    ...
    {
    	arbolCadenas.clear();
    	for(Object elementosLista : objetos) {
    		arbolCadenas.add((String)elementosLista);
    	}
    }
    ...
    {
    	TreeSet<String> arbolCadenasAux = new TreeSet<String>( );
    	for(String elementosArbol : arbolCadenas) {
    		elementosArbol = elementosArbol.toUpperCase();
    		arbolCadenasAux.add(elementosArbol);
    	}
    	arbolCadenas = arbolCadenasAux;
    }
    ...
    {
    	TreeSet<String> arbolReturn = new TreeSet<String>();
    	String prueba = new String("AAAAAa");
    	for(String elementosArbol : arbolCadenas) {
    		String nuevoStringInvertiro = "";
    		for (int i = elementosArbol.length() - 1; i >= 0; i--) {
    			nuevoStringInvertiro += elementosArbol.charAt(i);
    			arbolReturn.add(nuevoStringInvertiro);
    		}
    	}
        return arbolReturn;
    }
    ...
    {
		for(String elementosArreglo : otroArreglo) {
			if(!arbolCadenas.contains(elementosArreglo)) {
				return false;
			}
		}
		return true;
